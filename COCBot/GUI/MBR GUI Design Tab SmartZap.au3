...
$tabSmartZap = GUICtrlCreateTabItem("Smart Zap")
	;;;;;;;;;;;;;;;;;
    ;;;;SmartZap;;;;;
    ;;;;;;;;;;;;;;;;;
    Local $x = 35, $y = 155
    $grpStatsMisc = GUICtrlCreateGroup(GetTranslated(16, 1, "Smart Zap Settings"), $x - 20, $y - 20, 218, 95)
		...
		$chkSmartZapDB = GUICtrlCreateCheckbox("Only Zap Drills in Dead Bases", $x + 20, $y + 21, -1, -1)
			...
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetOnEvent(-1, "SmartZapDB")
			GUICtrlSetState(-1, $GUI_CHECKED)
			GUICtrlSetState(-1, $GUI_DISABLE)
		$lblSmartZap = GUICtrlCreateLabel(GetTranslated(16, 6, "Min. amount of Dark Elixir"), $x - 10, $y + 47, -1, -1)
		$txtMinDark = GUICtrlCreateInput("478", $x + 155, $y + 45, 35, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			...
			GUICtrlSetState(-1, $GUI_DISABLE)
	Local $x = 236, $y = 155
		$grpStatuszap = GUICtrlCreateGroup(GetTranslated(16, 10, "Status"), $x, $y - 20, 218, 95)
		...
		$txtTip = GetTranslated(16, 11, "Number of dark elixir zapped during the attack with lightning.")
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlCreateIcon($pIconLib, $eIcnLightSpell, $x + 160, $y + 40, 24, 24)
		$lblLightningUsed = GUICtrlCreateLabel("0", $x + 60, $y + 40, 80, 30, $SS_RIGHT)
			GUICtrlSetFont(-1, 16, $FW_BOLD, Default, "arial", $CLEARTYPE_QUALITY)
			GUICtrlSetColor(-1, 0x279B61)
			$txtTip = GetTranslated(16, 12, "Amount of used spells.")
			GUICtrlSetTip(-1, $txtTip)
